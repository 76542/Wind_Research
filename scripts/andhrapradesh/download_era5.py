"""
scripts/andhrapradesh/download_era5.py
Usage: python -m scripts.andhrapradesh.download_era5
"""
...
OUTPUT_DIR = Path(os.path.join(BASE_DIR, "data", "raw", "andhrapradesh", "era5_downloads"))
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

BBOX = [19.5, 79.0, 13.5, 84.0]  # [N, W, S, E]
OVERPASS_HOUR = "07:00"

print("Reading Andhra Pradesh SAR timeseries...")
...
for year in sorted(overpass_dates["year"].unique()):
    out_file = OUTPUT_DIR / f"era5_andhrapradesh_100m_wind_{year}.nc"
    if out_file.exists():
