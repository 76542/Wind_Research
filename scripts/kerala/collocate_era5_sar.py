"""
scripts/kerala/collocate_era5_sar.py
Usage: python -m scripts.kerala.collocate_era5_sar
"""
import os, xarray as xr, pandas as pd, numpy as np
from pathlib import Path

BASE_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
SAR_FILE = os.path.join(BASE_DIR, "data", "processed", "kerala", "kerala_sar_timeseries.csv")
GRID_FILE = os.path.join(BASE_DIR, "data", "raw", "kerala", "kerala_sampling_grid.csv")
ERA5_DIR = Path(os.path.join(BASE_DIR, "data", "raw", "kerala", "era5_downloads"))
OUTPUT_FILE = os.path.join(BASE_DIR, "data", "processed", "kerala", "kerala_era5_collocated.csv")
...
era5_files = sorted(ERA5_DIR.glob("era5_kerala_*.nc"))
