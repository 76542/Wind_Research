"""
scripts/kerala/download_era5.py
Usage: python -m scripts.kerala.download_era5
"""
...
OUTPUT_DIR = Path(os.path.join(BASE_DIR, "data", "raw", "kerala", "era5_downloads"))
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

BBOX = [12.0, 74.0, 8.0, 77.5]  # [N, W, S, E]
OVERPASS_HOUR = "07:00"

print("Reading Kerala SAR timeseries...")
...
for year in sorted(overpass_dates["year"].unique()):
    out_file = OUTPUT_DIR / f"era5_kerala_100m_wind_{year}.nc"
    if out_file.exists():
