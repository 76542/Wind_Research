"""
scripts/tamilnadu/collocate_era5_sar.py
Usage: python -m scripts.tamilnadu.collocate_era5_sar
"""
...
GRID_FILE = os.path.join(BASE_DIR, "data", "raw", "tamilnadu", "tamilnadu_sampling_grid.csv")
ERA5_DIR = Path(os.path.join(BASE_DIR, "data", "raw", "tamilnadu", "era5_downloads"))
OUTPUT_FILE = os.path.join(BASE_DIR, "data", "processed", "tamilnadu", "tamilnadu_era5_collocated.csv")
...
era5_files = sorted(ERA5_DIR.glob("era5_tamilnadu_*.nc"))
