...
def main():
    ...
    def make_map(cols, title_prefix, filename, subtitle):
        if HAS_CARTOPY:
            ...
            fig, axes = plt.subplots(1, len(cols), figsize=(9 * len(cols), 13),
        ...
        fig.suptitle(
            f'Offshore Wind Resource: Mean Speed & Power Density — Indian West Coast (2020-2024)\n'
            f'{subtitle}',
    ...
    make_map(
        ...
        'MLP v3 (SAR)', 'west_coast_meanwind_wpd_heatmap.png',
