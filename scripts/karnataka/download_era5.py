"""
scripts/karnataka/download_era5.py
Usage: python -m scripts.karnataka.download_era5
"""
...
OUTPUT_DIR = Path(os.path.join(BASE_DIR, "data", "raw", "karnataka", "era5_downloads"))
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

BBOX = [14.9, 73.0, 11.8, 75.5]  # [N, W, S, E]
OVERPASS_HOUR = "07:00"

print("Reading Karnataka SAR timeseries...")
...
for year in sorted(overpass_dates["year"].unique()):
    out_file = OUTPUT_DIR / f"era5_karnataka_100m_wind_{year}.nc"
    if out_file.exists():
