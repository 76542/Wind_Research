"""
scripts/karnataka/collocate_era5_sar.py
Usage: python -m scripts.karnataka.collocate_era5_sar
"""
import os, xarray as xr, pandas as pd, numpy as np
from pathlib import Path

BASE_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
SAR_FILE = os.path.join(BASE_DIR, "data", "processed", "karnataka", "karnataka_sar_timeseries.csv")
GRID_FILE = os.path.join(BASE_DIR, "data", "raw", "karnataka", "karnataka_sampling_grid.csv")
ERA5_DIR = Path(os.path.join(BASE_DIR, "data", "raw", "karnataka", "era5_downloads"))
OUTPUT_FILE = os.path.join(BASE_DIR, "data", "processed", "karnataka", "karnataka_era5_collocated.csv")
...
era5_files = sorted(ERA5_DIR.glob("era5_karnataka_*.nc"))
