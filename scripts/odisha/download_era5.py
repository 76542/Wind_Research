"""
scripts/odisha/download_era5.py
Usage: python -m scripts.odisha.download_era5
"""
...
OUTPUT_DIR = Path(os.path.join(BASE_DIR, "data", "raw", "odisha", "era5_downloads"))
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

BBOX = [22.0, 84.0, 19.0, 88.0]  # [N, W, S, E]
OVERPASS_HOUR = "07:00"

print("Reading Odisha SAR timeseries...")
...
for year in sorted(overpass_dates["year"].unique()):
    out_file = OUTPUT_DIR / f"era5_odisha_100m_wind_{year}.nc"
    if out_file.exists():
